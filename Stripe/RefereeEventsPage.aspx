                        ...
                        <div class='uno fontawesome-umbrella article'>
                                ...
                                <div class="col-xs-1 col-sm-1 col-md-9 col-lg-9">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <center><b><p style="font-size:25px !important;font-weight:750">PREVIOUS EVENT LIST</p></b></center>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-1 col-sm-1 col-md-9 col-lg-9">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <center><b><p style="font-size:25px !important;font-weight:750">UPCOMING EVENT LIST</p></b></center>
                                        </div>
                                        <div class="panel-body">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="text-center">
                                                                <asp:LinkButton ID="registerForEvent" runat="server" CssClass="btn btn-success btn-lg" OnClick="registerAsReferee">
                                                        ...
                                                        <tr>
                                                            <td class="text-center">
                                                                <asp:LinkButton ID="DeclineEvent" runat="server" CssClass="btn btn-danger btn-lg" OnClick="denyAsReferee">
                                                        <i aria-hidden="true" class="glyphicon glyphicon-floppy-disk"></i> Decline</asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-center">
                                                                <asp:Label ID="NoNewEventToRegister" runat="server" Text=""></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
