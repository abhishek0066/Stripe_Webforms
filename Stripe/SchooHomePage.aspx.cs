...
namespace Stripe
{
    ...
    {   //UserProfileID required as a cookie
        ...
        int schoolId;
        //Change Here
        int schoolDirectorUserProfileId = 1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                    ...
                    try
                    {
                        ...
                        if (reader.HasRows)
                        {
                            while (reader.Read())
                            {
                                ...
                                schoolDirectorLoginID = Int32.Parse(reader.GetString(13));
            ...
            createUserCookie.Values["schoolDirectorUsername"] = schoolDirectorUserProfileId.ToString();
