...
namespace Stripe
{
    ...
    {   //UserProfileID required as a cookie
        ...
        {
            int schoolDirectorLoginId = Convert.ToInt32(Session["loginid"]);
            if (schoolDirectorLoginId != 0)
            {
                    ...
                    using (SqlCommand command = connection.CreateCommand())
                    {
                        ...
                        try
                        {
                            ...
                            if (reader.HasRows)
                            {
                                if (reader.Read())
                                {
                                    schoolDirectorUserProfileId = reader.GetInt32(0);
                ...
                Session["userid"] = schoolDirectorUserProfileId;
        ...
        {
            Response.Redirect("SchoolUpdateInformationPage.aspx");
        }
